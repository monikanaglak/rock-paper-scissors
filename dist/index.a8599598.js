...
/*******user informations***********************************************************************/ user.classList.add("user-box");
...
/*************************computer box*********************************************************/ computer.innerHTML = "Computer";
...
/*************************compteur***********************************************************/ /************array of choice*******************************************************************/ const choice = [
    "paper",
    "rock",
    "scissors"
];
...
/**************************making buttons*******************************************************/ for(let i = 0; i < choice.length; i++){
...
/******************************************getting to know who won****************************** */ function getResult(userChoice, computerChoice) {
...
function userwon() {
    ...
    if (userCompteurDiplay.innerHTML == 3) gameOver.innerHTML = "Game over";
}
function computerwon() {
    resultDisplay.innerHTML = "Computer Won";
    computerCompteurDiplay.textContent++;
    console.log(computerCompteurDiplay.textContent);
    if (computerCompteurDiplay.innerHTML == 3) gameOver.innerHTML = "Game over";
}
function egalite() {
    resultDisplay.innerHTML = "nobody won";
}

//# sourceMappingURL=index.a8599598.js.map
